...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0619197999d54329975e1d4e998d15b0) *)
(*
     ...
     package =
       {
          ...
          homepage = Some "https://forge.ocamlcore.org/projects/lbfgs/";
          synopsis =
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Bzr;
                      src_repo_location =
                        "https://forge.ocamlcore.org/anonscm/bzr/lbfgs/trunk";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "examples/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lbfgs"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "error.ml"; });
               Executable
                 ({
                     cs_name = "Rosenbrock";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Lbfgs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Flag
                 ({
                     ...
                     },
                   {
                      flag_description =
                        Some
                          "Whether the lacaml findlib package is installed.";
                     ...
                     },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "has_lacaml", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/";
                      bs_compiled_object = Byte;
                      ...
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, ["../src"])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])];
                      },
                   {exec_custom = false; exec_main_is = "unconstrained.ml"; })
            ];
          plugins =
